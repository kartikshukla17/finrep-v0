...
function ComparisonCategoryMobile({
  title,
  features,
            ...
            <div className="w-full h-10 bg-[#F9F9FA] rounded-lg flex justify-start items-center">
              <div className="flex-1 h-full flex justify-center items-center">
                <Image
                  src={
                    feature.finrep
                      ? "/assets/icons/Compare cell-1.svg"
                      : "/assets/icons/Compare cell.svg"
                  }
...
function ComparisonCategoryDesktop({
  title,
  features,
}: ComparisonCategoryProps) {
  return (
    <div className="hidden lg:flex w-full flex-col justify-start items-start gap-4">
      ...
      <div className="w-full flex flex-col justify-start items-start">
        {features.map((feature, index) => (
          ...
          >
            <div
              className={`flex-1 ${feature.longText ? "h-auto py-2" : "h-12"} px-2.5 py-[9px] flex justify-start items-center gap-2.5`}
            >
              <Image
...
const comparisonData = [
  {
    ...
    features: [
      ...
      {
        name: "Evidence-backed answers with citations",
        finrep: true,
        others: false,
      },
      {
        name: "Source inspection for every answer",
        finrep: true,
        others: false,
      },
      {
        name: "Chat across filings, guidance, peers, comment letters",
        finrep: true,
        others: true,
      },
      {
        name: "True boolean keyword search + advanced filters",
        finrep: true,
        others: true,
      },
      {
        name: "Save searches, watchlists, repeatable workflows",
        finrep: true,
        others: false,
      },
      {
        name: "Chat with your private uploads in the same workflow",
        finrep: true,
        others: false,
      },
    ],
  },
  {
    ...
    features: [
      ...
      {
        name: "Structured benchmarking grids (matrix style)",
        finrep: true,
        others: true,
      },
      {
        name: "Verbatim excerpts plus AI crux summaries toggle",
        finrep: true,
        others: false,
      },
      {
        name: "Side-by-side disclosure comparison across peers and periods",
        finrep: true,
        others: true,
      },
      {
        name: "Evidence links embedded in comparison outputs",
        finrep: true,
        others: false,
      },
      {
        name: "Share-for-review flows built into the workflow",
        finrep: true,
        others: false,
      },
    ],
  },
  {
    ...
    features: [
      {
        name: "Guidance-aware drafting grounded in precedent",
        finrep: true,
        others: false,
      },
      {
        name: "Draft companion integrated with research and benchmarking",
        finrep: true,
        others: false,
      },
      {
        name: "Checklist benchmarking mapped to evidence (FASB-aligned review)",
        finrep: true,
        others: false,
      },
      {
        name: "Roll-forward disclosure workflows (reuse with control)",
        finrep: true,
        others: false,
      },
    ],
  },
  {
    ...
    features: [
      {
        name: "Comment letter analytics and focus-area reporting",
        finrep: true,
        others: false,
      },
      {
        name: "Proactive monitoring layer (alerts + dashboard)",
        finrep: true,
        others: false,
      },
      {
        name: "Central command center for ongoing reporting work",
        finrep: true,
        others: false,
      },
    ],
  },
  {
    ...
    features: [
      ...
      {
        name: "Electronic filing to SEC EDGAR (test + live)",
        finrep: true,
        others: true,
      },
      {
        name: "One-click filing and status retrieval from EDGAR",
        finrep: true,
        others: true,
      },
      {
        name: "File for multiple reporting owners",
        finrep: true,
        others: true,
      },
      {
        name: "Footnote capability / footnote library",
        finrep: true,
        others: true,
      },
      {
        name: "Central registry for securities and instruments",
        finrep: true,
        others: true,
      },
      {
        name: "Unified transaction ledger with states (unreported, in draft, filed)",
        finrep: true,
        others: false,
      },
      {
        name: "Unreported transactions queue with resolution paths",
        finrep: true,
        others: false,
      },
      {
        name: "Predictive triggers from vesting schedules",
        finrep: true,
        others: false,
      },
      {
        name: "Deterministic validations (math, table rules, XML compliance) before filing",
        finrep: true,
        others: false,
        longText: true,
      },
      {
        name: "Role-based permissions (admin file rights, editor, viewer)",
        finrep: true,
        others: false,
      },
      {
        name: "Audit trail: who changed what, when, and why",
        finrep: true,
        others: true,
      },
      {
        name: "Store accession numbers and archive filed history (draft + filed)",
        finrep: true,
        others: false,
      },
    ],
  },
  {
    ...
    features: [
      ...
      {
        name: "Enterprise security documentation (trust center)",
        finrep: true,
        others: true,
      },
      {
        name: "Expert support and guided onboarding",
        finrep: true,
        others: true,
      },
    ],
...
export default function ComparisonTable() {
  return (
    <div className="w-full bg-white">
      <div className="w-full max-w-[1440px] mx-auto px-5 lg:px-10 py-20 lg:pt-30 lg:pb-30 flex justify-center lg:justify-start">
        <div className="w-full max-w-[372px] lg:max-w-none flex flex-col justify-start items-start gap-6 lg:gap-[42px]">
          ...
          <div className="w-full flex flex-col justify-start items-start gap-2 lg:hidden">
            ...
            <p className="w-full text-[#3F4346] text-xl font-medium font-articulat leading-8">
              Here is what you get with Finrep compared to traditional tools and
