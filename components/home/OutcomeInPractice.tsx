...
const outcomeCards = [
    {
        description: "Disclosure comparison & EDGAR search cut month‑end prep from 10 days to 3–4 days.",
        title: "Prep time",
        stat: "60–70%",
        hasArrow: true,
    },
    {
        description: "Checklist benchmarking and AI summaries reduced back‑and‑forth with auditors.",
        title: "Review Loops",
        stat: "60–70%",
        hasArrow: true,
    },
    {
        description: "Comment Letters Explorer highlights focus areas that previously drew staff comments.",
        title: "SEC Pushbacks",
