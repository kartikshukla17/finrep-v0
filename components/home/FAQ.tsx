    ...
    return (
        <div className="relative w-full bg-white">
            <div className="w-full max-w-[1440px] mx-auto px-4 lg:px-[120px] py-8 lg:py-12 flex flex-col justify-start items-center gap-6 lg:gap-12">
                {/* Header */}
                <div className="w-full max-w-[372px] lg:max-w-full flex flex-col justify-start items-start gap-12">
                ...
                {/* FAQ Items */}
                <div className="w-full max-w-[372px] lg:max-w-[1200px] flex flex-col justify-start items-start gap-4 lg:gap-6">
                    {faqs.map((faq, index) => {
