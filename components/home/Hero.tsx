    ...
    <div className="relative w-full min-height:100vh bg-[#0D352A] overflow-hidden">
      ...
      <div className="relative w-full max-w-[1440px] mx-auto h-full flex flex-col items-center pt-[72px]">
        ...
        >
          ...
          {/* Trust Badges */}
          <motion.div
            className="flex flex-wrap justify-center items-start gap-4 md:gap-9 mb-9 md:mb-[74px] px-4"
          ...
          >
            ...
            {/* Desktop: Grid Layout */}
            <div className="hidden lg:flex justify-center items-center gap-9 px-4 flex-wrap">
            ...
            <div className="lg:hidden w-full overflow-hidden">
              ...
              >
                ...
                {[...companyLogos, ...companyLogos].map((logo, i) => (
                  <div
                    key={`${logo.id}-${i}`}
                    className="h-[32px] flex items-center justify-center flex-shrink-0"
                  >
                    <Image
                      src={logo.src}
                      alt={`${logo.name} logo`}
