...
const experienceLogos: Logo[] = [
  {
    src: "/assets/company_logos/jpmorgan-logo.svg",
    alt: "JPMorgan Chase",
    width: 182,
    height: 26,
    opacity: "opacity-80",
  ...
  {
    src: "/assets/company_logos/sixt-logo.png",
    alt: "Sixt",
    width: 96,
    height: 54,
    opacity: "opacity-70",
  ...
  {
    src: "/assets/company_logos/strive-logo.png",
    alt: "Strive",
    width: 140,
    height: 73,
    opacity: "opacity-70",
  ...
  {
    src: "/assets/company_logos/y-combinator-logo.png",
    alt: "Y Combinator",
    width: 194,
    height: 37,
    mixBlendMode: true,
  ...
  {
    src: "/assets/company_logos/meesho-logo.png",
    alt: "Meesho",
    width: 114,
    height: 40,
    opacity: "opacity-70",
  ...
  {
    src: "/assets/company_logos/flipkart-logo.png",
    alt: "Flipkart",
    width: 212,
    height: 84,
    mixBlendMode: true,
  ...
  return (
    <>
      ...
      <div className="w-full bg-white py-12 px-5 lg:hidden ">
        <div className="max-w-[372px] mx-0 flex flex-col gap-12">
          <div className="flex flex-col items-start gap-1">
            <h2 className="text-black text-[42px] font-medium font-articulat leading-normal text-left">
              Built with experience
            </h2>
            <p className="text-[#3F4346] text-xl font-normal font-articulat leading-8 text-left">
